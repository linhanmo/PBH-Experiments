...
load_from = 'experiments/CUT/weights/pruned30_base_init.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        num_expert=6,
        part_features=192,
        mlp_hidden_dims=[3072, 3072, 3072, 3072, 1088, 1088, 1088, 1088, 1152, 1152, 1152, 1152],
    ),
    keypoint_head=dict(
...
work_dir = 'experiments/CUT/work_dirs/pruned30_coco_finetune'
