...
CFG="${CFG:-experiments/CUT/pruned40_coco_finetune.py}"
WORK_DIR="${WORK_DIR:-experiments/CUT/work_dirs/pruned40_coco_finetune}"
LOG_FILE="${LOG_FILE:-experiments/CUT/logs/finetune_pruned40_coco.log}"
SUMMARY_LOG="${SUMMARY_LOG:-experiments/CUT/logs/finetune_pruned40_coco.summary.log}"
