...
CFG="${CFG:-experiments/CUT/pruned30_coco_finetune.py}"
WORK_DIR="${WORK_DIR:-experiments/CUT/work_dirs/pruned30_coco_finetune}"
LOG_FILE="${LOG_FILE:-experiments/CUT/logs/finetune_pruned30_coco.log}"
SUMMARY_LOG="${SUMMARY_LOG:-experiments/CUT/logs/finetune_pruned30_coco.summary.log}"
