...
CFG="${CFG:-vitb_posebh_pruned20.py}"
WORK_DIR="${WORK_DIR:-work_dirs/pruned20_coco/}"
WEIGHT_OUT="${WEIGHT_OUT:-weights/pruned20_base_init.pth}"
LOG_FILE="${LOG_FILE:-logs/prune_pruned20.log}"
RESUME="${RESUME:-0}"
