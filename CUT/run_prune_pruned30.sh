...
CFG="${CFG:-vitb_posebh_pruned30.py}"
WORK_DIR="${WORK_DIR:-work_dirs/pruned30_coco/}"
WEIGHT_OUT="${WEIGHT_OUT:-weights/pruned30_base_init.pth}"
LOG_FILE="${LOG_FILE:-logs/prune_pruned30.log}"
RESUME="${RESUME:-0}"
